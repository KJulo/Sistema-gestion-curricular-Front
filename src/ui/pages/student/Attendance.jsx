...
import {
  ...
  useIsSameMonth } from '@hooks/useDate';
...
const Attendance = () => {
    ...
    if (selectedDate.split('-')[0].length == 4) console.log('la fecha fue borrada, no hacer busqueda aun');
	}, [selectedDate])
		...
		<div className="site-page-header-ghost-wrapper home-grid-layout all-height" style={{ margin: "0 40px 0 0", padding: 0 }}>
			...
			<div className="content" style={{ marginTop: 60, marginLeft: 20 }}>
				<div className='header-container'>
    				...
    				<DatePicker defaultValue={moment(currentDate, 'MM-YYYY')} picker='month' onChange={onChange} />
					</Space>
				</div>
